export default function PPTForm({ setProject, setShowCreate }) {
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 bg-[rgba(0,0,0,0.3)] flex items-center justify-center z-[200]">
      <div className="bg-white p-8 gap-10 w-1/2 flex flex-col shadow-xl">
        ...
        >
          <fieldset className="flex col-span-3 flex-col gap-1">
          ...
          <fieldset className="flex flex-col col-span-1 gap-1">
          ...
          <fieldset className="flex flex-col col-span-5 gap-1">
            <label
